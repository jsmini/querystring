...
describe('单元测试', function () {
  ...
  describe('parse', function () {
    it('param check', function () {
      expect(function () {
        parse({});
      }).to.throwException('parse: first param must is string');
    });
  ...
  describe('stringify', function () {
    it('param check', function () {
      expect(function () {
        stringify('');
      }).to.throwException('stringify: first param must is object');
    });
